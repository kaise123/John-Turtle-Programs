...
local SlotItemCobble = turtle.getItemCount(4) -- How much cobble is in slot 4 (Filling Slot)
local SlotTorchChest = turtle.getItemCount(5) -- Is there a chest in slot 5 (Torches EnderChest)
...
local function Check()
	if torch == 0 then
		print("No Torches - Please fill slot 1 with torches!")
		Error = 1
	else
		print("Torches are present in slot 1.")
	end
	if chest == 0 then
		print("There is no chest in slot 2")
		Error = 1
	else
		print("EnderChest is present in slot 2.")
	end
	if ItemFuel == 0 then
		print("No Fuel - Place Coal in slot 3")
		Error = 1
	else
		print("Fuel is present in slot 3.")
	end
	if SlotItemCobble == 0 then
		print("No cobblestone. Please fill slot 4 with a stack of cobblestone.")
		Error = 1
	else
		print("Cobble present in slot 4")
	end
	if SlotTorchChest == 0 then
		print("No torches chest. Please put Torch EnderChest in slot 5.")
		Error = 1
	else
		print("Torch Chest present in slot 5.")
	end
	repeat
